...
// This assumes you have an authService file, if not, you can remove this line
...
const LoginScreen = () => {
  ...
  const handleLogin = async (e) => {
    ...
    // Using a timeout to simulate network delay for demo purposes
    setTimeout(() => {
        ...
        triggerSuccessAnimation(role);
    }, 1000);
  };

  const triggerSuccessAnimation = (userRole) => {
    setFadeOut(true);
    setTimeout(() => {
            ...
            >
              ...
              >
                ...
                <Box component="form" onSubmit={handleLogin} sx={{ mt: 2 }}>
                  ...
                  {/* --- THIS BUTTON IS NOW ADDED --- */}
                  <Button
                    fullWidth
                    variant="text"
                    onClick={() => navigate('/register')} // Navigates to the register route
                  >
                    New here? Register
                  </Button>
                </Box>
